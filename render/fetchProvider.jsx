import { responseValidation } from '../src/setup/utility/responseValidation'
import { convertErrorToResponse } from '../src/setup/utility/convertErrorToResponse'

// fetch data of component from server
export const fetchProvider = async (DUCT) => {
