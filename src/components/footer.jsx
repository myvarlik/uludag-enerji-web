                        ...
                        <div className="inleft">
                            ...
                            <div className="minimal">
                                ...
                                <div className="social">
                                    <a href="https://www.facebook.com/uludagenerji1" target={"_blank"}><i className="fab fa-facebook-f"></i></a>
                                    {/* <a className="sactive" href="#"><i className="fab fa-twitter"></i></a> */}
                                    <a href="https://www.instagram.com/uludag.enerji" target={"_blank"}><i className="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
