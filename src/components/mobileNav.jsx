        ...
        <>
            <div className="mainMobileNav" style={{ display: display ? 'block' : 'none' }}>
                <ul>
                    ...
                    <li><a className="y1" href="http://panel.uludagenerji.com/" target={"_blank"}>Yönetici Girişi</a></li>
                    <li><a className="y2" href="http://panel.uludagenerji.com/" target={"_blank"}>Daire Girişi</a></li>
                </ul>
            </div>
